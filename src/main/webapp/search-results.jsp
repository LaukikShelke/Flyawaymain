...
<div class="container">
    ...
    <table class="table table-hover table-striped">
        ...
        <tr bgcolor="#F5F5F5">
            ...
            <td><%=resultSet.getString("fsource")%></td>
            <td><%=resultSet.getString("fdestination")%></td>
            <td><%=Search.date%></td>
            <td><%=resultSet.getString("price") %></td>
            <td>
                <form action="${pageContext.request.contextPath}/booking-details.jsp" method="post">
                    <input type="hidden" id="name" name="name" value="<%=resultSet.getString("fname")%>">
                    <input type="hidden" id="ticket_price" name="ticket_price" value="<%=resultSet.getString("price")%>">
